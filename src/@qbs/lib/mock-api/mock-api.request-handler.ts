...
import { QbsMockApiReplyCallback } from './mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class QbsMockApiHandler {
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: QbsMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: QbsMockApiReplyCallback): void {
        // Store the reply
