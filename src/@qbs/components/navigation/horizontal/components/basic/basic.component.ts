...
import { QbsHorizontalNavigationComponent } from '../../../horizontal/horizontal.component';
...
@Component({
    selector: 'qbs-horizontal-navigation-basic-item',
...
export class QbsHorizontalNavigationBasicItemComponent
