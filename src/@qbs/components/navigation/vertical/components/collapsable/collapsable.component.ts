...
import { QbsVerticalNavigationBasicItemComponent } from '../basic/basic.component';
import { QbsVerticalNavigationDividerItemComponent } from '../divider/divider.component';
import { QbsVerticalNavigationGroupItemComponent } from '../group/group.component';
import { QbsVerticalNavigationSpacerItemComponent } from '../spacer/spacer.component';
import { QbsVerticalNavigationComponent } from '../../vertical.component';
import { Subject, filter, takeUntil } from 'rxjs';

@Component({
    selector: 'qbs-vertical-navigation-collapsable-item',
    ...
    implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'qbs-vertical-navigation-item-collapsed': this.isCollapsed,
            'qbs-vertical-navigation-item-expanded': this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void {
        ...
        this._qbsVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if (this.autoCollapse) {
            this._qbsVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void {
        ...
        this._qbsVerticalNavigationComponent.onCollapsableItemCollapsed.next(
            this.item
        );
    }
    ...
    expand(): void {
        ...
        // Execute the observable
        this._qbsVerticalNavigationComponent.onCollapsableItemExpanded.next(
            this.item
        );
    }
