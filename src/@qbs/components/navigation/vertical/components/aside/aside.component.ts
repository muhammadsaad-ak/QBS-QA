...
import { QbsVerticalNavigationCollapsableItemComponent } from '../collapsable/collapsable.component';
...
@Component({
    selector: 'qbs-vertical-navigation-aside-item',
...
export class QbsVerticalNavigationAsideItemComponent
