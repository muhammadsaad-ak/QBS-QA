...
import { QbsHighlightService } from './highlight.service';

@Component({
    selector: 'textarea[qbs-highlight]',
    templateUrl: './highlight.component.html',
    styleUrls: ['./highlight.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'qbsHighlight',
    standalone: true,
    imports: [NgClass],
})
export class QbsHighlightComponent implements OnChanges, AfterViewInit {
    private _domSanitizer = inject(DomSanitizer);
    private _elementRef = inject(ElementRef);
    private _qbsHighlightService = inject(QbsHighlightService);
    ...
    private _highlightAndInsert(): void {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(
            ...
            this._qbsHighlightService.highlight(this.code, this.lang)
        );
