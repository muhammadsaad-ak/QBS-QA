...
const slideInTop = trigger('slideInTop', [
    ...
    transition('void => *', animate('{{timings}}'), {
        params: {
            timings: `${QbsAnimationDurations.entering} ${QbsAnimationCurves.deceleration}`,
        },
    }),
]);
...
const slideOutTop = trigger('slideOutTop', [
    ...
    transition('* => void', animate('{{timings}}'), {
        params: {
            timings: `${QbsAnimationDurations.exiting} ${QbsAnimationCurves.acceleration}`,
        },
    }),
]);
