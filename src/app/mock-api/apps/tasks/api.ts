...
import { QbsMockApiService } from '@qbs/lib/mock-api/mock-api.service';
import { QbsMockApiUtils } from '@qbs/lib/mock-api/mock-api.utils';
import {
    tags as tagsData,
    tasks as tasksData,
    ...
    registerHandlers(): void {
        ...
        this._qbsMockApiService
            ...
            .reply(({ request }) => {
                ...
                // Generate a new GUID
                newTag.id = QbsMockApiUtils.guid();
        ...
        // @ Tasks - GET
        // -----------------------------------------------------------------------------------------------------
        this._qbsMockApiService.onGet('api/apps/tasks/all').reply(() => {
            // Clone the tasks
