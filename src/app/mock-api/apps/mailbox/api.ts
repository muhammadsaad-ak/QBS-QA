...
import {  QbsMockApiUtils, QbsMockApiService } from '@qbs/lib/mock-api';
import {
...
export class MailboxMockApi {
    ...
    registerHandlers(): void {
        ...
        // @ Folders - GET
        // -----------------------------------------------------------------------------------------------------
        this._qbsMockApiService.onGet('api/apps/mailbox/folders').reply(() => {
            let count = 0;
