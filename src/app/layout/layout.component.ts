...
import { QbsConfig, QbsConfigService } from '../../@qbs/services/config';
import {  QbsMediaWatcherService } from '../../@qbs/services/media-watcher';
import { QbsPlatformService } from '../../@qbs/services/platform';
import { QBS_VERSION } from '../../@qbs/version';
...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _qbsConfigService: QbsConfigService,
        private _qbsMediaWatcherService: QbsMediaWatcherService,
        private _qbsPlatformService: QbsPlatformService
    ) {}
    ...
    ngOnInit(): void {
        ...
        combineLatest([
            this._qbsConfigService.config$,
            this._qbsMediaWatcherService.onMediaQueryChange$([
        ...
        this._renderer2.addClass(
            this._document.body,
            this._qbsPlatformService.osName
        );
    }
