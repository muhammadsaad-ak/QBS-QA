...
import { QualitativeResultComponent } from '../../../list-of-qualitative-result/qualitative-result/qualitative-result.component';
...
export class EditUnitMeasureSetupComponent implements OnInit, AfterViewInit, OnDestroy {
