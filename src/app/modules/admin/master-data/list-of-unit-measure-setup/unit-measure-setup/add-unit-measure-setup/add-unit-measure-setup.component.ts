...
@Component({
  selector: 'app-add-unit-measure-setup',
  standalone: true,
  templateUrl: './add-unit-measure-setup.component.html',
  styleUrl: './add-unit-measure-setup.component.scss',
...
export class AddUnitMeasureSetupComponent implements OnInit, AfterViewInit, OnDestroy {

   @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer;
  
    addUnitMeasureSetupForm: FormGroup;
    ...
    constructor(
      ...
      this.addUnitMeasureSetupForm = this._formBuilder.group({
        inspectionCode: [''],
        description: [''],
        inspectionType: [''],
        status: [''],
    ...
    get qualitativeCriteria(): FormArray {
      return this.addUnitMeasureSetupForm.get('qualitativeCriteria') as FormArray;
    }
